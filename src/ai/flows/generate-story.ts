...
2.  **Story**: Write a complete story consisting of approximately 15-20 paragraphs. **Each paragraph, including the very first one, must be at least 5 sentences long.**
    ...
    - **Targeted Level**: The vocabulary and grammatical structures must be appropriate for the specified level. A higher level means more diverse and complex vocabulary and sentence structures, not just longer sentences.
